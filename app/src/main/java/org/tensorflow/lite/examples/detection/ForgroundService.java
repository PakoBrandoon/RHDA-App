...
class ForegroundService extends Service implements Camera.PreviewCallback {
    ...
    private TextureView.SurfaceTextureListener surfaceTextureListener = new TextureView.SurfaceTextureListener() {
        ...
        public void onSurfaceTextureSizeChanged(SurfaceTexture surface, int width, int height) {
            LOGGER.e("previewframe","jalan coy 2");
        }
        ...
        public void onSurfaceTextureUpdated(SurfaceTexture surface) {
            LOGGER.e("previewframe","jalan coy 1");
        }
    };
    private byte[] bytes;
    ...
    private void initcam(int width, int height) {
        ...
        for (int i = 0; i < CameraIdList.length; i++) {
            ...
            try {
                ...
                LOGGER.d("facingservice","service : " + facing);
        ...
        LOGGER.e("previewSizehaha","preview size service kedua= " + previewSize + " , cam ID = " + CamId + " width = " + width + " Height =  " + height);
